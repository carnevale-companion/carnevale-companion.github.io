...
**How does Boiling Veins work?** If a Mage (2) rolls 5 Aces for their Magic Roll, they subtract 2 from the total Aces, for an initial Damage value of 3. The target then takes 3 Damage with Penetration -2 (the caster's Mage (X) value). If the target is killed by this damage, before removing them, place the Blast marker over them. Each other character (friendly and enemy) touched by the template loses 5 Life Points.
